...
import social.ufind.ui.screen.signup.viewmodel.SignUpViewModel
...
fun SignUpScreen(
    ...
    Column(
        ...
        SignUpBody(modifier = Modifier.align(Alignment.CenterHorizontally).fillMaxHeight().weight(11f), viewModel = viewModel)
